'''
 A web scrapping application which can take url of a webpage or wikipedia
 and shows their HTML, Tag and div counts

Libraries I am using:
1. From bs4, I will import BeautifulSoup
2. I will import requests for establishing a connection

Features:
1. The program will ask the user for a particular task to do
2. It can scrap webpage data and show their html, tag and div count, links as well
3. It can also scrap Wikipedia page data
'''
